...
interfaz:-
    ...
    new(@texto,label(nombre,'Segun lo que responda se le dará un resultado:')),
...
Cabe aclarar que se corre la siguiente instrucción para que Prolog
ejecute automáticamente la interfaz creada. Antes tienen que estar
