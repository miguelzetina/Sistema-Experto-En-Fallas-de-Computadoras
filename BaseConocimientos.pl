...
Los fallos se colocan como preguntas, que se irán mostrando una a una
*/
...
unidadesopt:-unidadesopt_daniadas,
    pregunta('La unidad no lee ningún disco?'),
...
impresora:-impresora_daniada,
    pregunta('Imprime caracteres no correspondientes a la impresión?'),
    pregunta('La impresión sale desalineada?').
...
unidadesopt_daniadas:- pregunta('La unidad no lee ningún disco?'),!.
